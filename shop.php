	...
	<div class="shop-area">
		<div class="container">
			<div class="row">
				...
				<h2 class="page-heading mt-100"><span class="cat-name">全部商品</span></h2>
				<div class="shop-bar">
					<ul class="shop-pagi">
					<li><a style="width: 60px" href="shop.php?act=0">价格↑</a></li>
					<li><a style="width: 60px" href="shop.php?act=1">价格↓</a></li>
					</ul>
							</div>	
							<!-- Tab panes -->
								...
								<div role="tabpanel" class="tab-pane active" id="home">
									<div class="row">
										<?php
											...
											//连接数据库
											$sql ="SELECT count(*) as 'count' from products";//查询记录的sql语句
											$result = mysql_query($sql);
											...
											$sql = "SELECT * from products order by nprice desc limit $start,$pagesize ";}//降序排序
											else{$sql = "SELECT * from products order by nprice limit $start,$pagesize ";}//升序排序
											$result=mysql_query($sql);
