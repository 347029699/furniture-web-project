...
<?php
	 $content=$_SERVER["QUERY_STRING"];//获取路径
	require("fun.php");
	?>
<head>
    <meta charset="utf-8">
			...
			<div class="row">
				<div class="col-sm-8" style="width: 100%">
								<?php
									...
									if(empty($content)){
										echo "<script>alert('搜索不能为空！');window.location.href='index.php';</script>";
									}else{
										$query=mysql_query("select * from products where name like '%$content%' or material like '%$content%'");
									}
								?>
				<h2 class="page-heading mt-100"><span class="cat-name">您搜索的关键词“<?php echo"$content"; ?>”，产品显示如下:</span></h2>
							<!-- Tab panes -->
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane active" id="home">
									<div class="row">
									<?php
									$result=mysql_query("select count(*) from products where name like '%$content%' or material like '%$content%'");
											...
											<div class="product-wrapper mb-40">
												...
												<div class="product-content">
													...
													<div class="price-reviews">
														<div class="price-box">
															<span class="price product-price">123￥</span>
															<span class="old-price product-price">123￥</span>
														</div>
													</div>
												</div>
											</div>
