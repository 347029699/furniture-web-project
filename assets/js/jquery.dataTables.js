...
(/** @lends <global> */function( $ ) {
	...
	function _fnAddOptionsHtml ( oSettings )
	{
		 ...
		 */
		oSettings.nTableWrapper = $('<div id="'+oSettings.sTableId+'_wrapper" class="'+oSettings.oClasses.sWrapper+'" role="grid" style="width:1500px"></div>')[0];
